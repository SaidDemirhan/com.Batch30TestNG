...
public class C03_MouseAction1 extends TestBase {
    ...
    public void test(){
        ...
        Assert.assertEquals(actualAllertYazisi,expectedAllertYazisi,
                "allert yazisi beklenenden farkli");
        //5- Tamam diyerek alert’I kapatalim
        ...
        Assert.assertEquals(actualIkinciSayfaYazisi,expectedIkinciSayfaYazi,
                "ikinci sayfadaki yai istenenden farkli");
    }
